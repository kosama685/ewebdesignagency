...
require_once 'config.php'; 
    ...
    //         $mail->Body .= '<a href="https://webappsolution.org/payment_us/paynow.php?token='.$link_token.'" style="color: #fff;
    ...
    // margin-top: 10px;">Complete Invoice</a>';
        ...
        if(!$mail->Send())
        {
            ...
            header('Location: https://webappsolution.org/payment_us/link-details.php?token='.$link_token);
         }
