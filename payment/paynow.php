    ...
    <div class="panel-body">
        ...
        <form action="charge.php" class="row" method="POST" id="payment-form">
            ...
            <div class="form-group col-md-12" style="margin-top: 35px;">
                <input type="checkbox" name="terms" id="terms" class="field form-control" placeholder="Terms" required="" style="float: left;  width: 20px; height: 25px; margin-right: 10px;">
                <label for="terms" style="float: left;">I agree to the <a href="https://www.webappsolution.org/terms-and-conditions" target="_blank">terms &amp; conditions</a> and the <a href="https://www.webappsolution.org/privacy-policy" target="_blank">privacy policy</a></label>
            </div>
